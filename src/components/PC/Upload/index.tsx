...
const useProps = (props: any) => {
  const uploadProps = computed(() =>
    Object.assign({}, pick(props, Object.keys(ElUpload.props)), useHandleUpload(props))
  )
  return {
    uploadProps
  }
  ...
  render() {
    ...
    return (
      <section class={this.customClass}>
          ...
          {Object.assign(
            {
              ...
              tip: () =>
                isFunction(slots.tip) ? (
                  slots.tip()
                ) : (
                  <div class="el-upload__tip">
                    {isNotEmptyString(this.accept) &&
        ...
        {!this.uploadProps.showFileList &&
          (isFunction(slots.filelist) ? (
            slots.filelist()
          ) : (
            <file-list
