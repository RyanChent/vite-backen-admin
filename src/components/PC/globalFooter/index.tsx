    ...
    setup() {
        ...
        return () => <div class="global-footer">
            ...
            <p class="footer-visit-info">
                <span id="busuanzi_container_site_pv">访问量&emsp;<span id="busuanzi_value_site_pv" />次</span>
                <span id="busuanzi_container_site_uv">访客数&emsp;<span id="busuanzi_value_site_uv" />人</span>
            </p>
        </div>
    }
})
