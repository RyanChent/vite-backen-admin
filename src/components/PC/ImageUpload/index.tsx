            ...
            <Upload
                ...
                v-draggable={[this.draggable && {
                    ...
                    callback: ({ newIndex, oldIndex }: any) => {
                        [this.imageList[newIndex], this.imageList[oldIndex]] = [this.imageList[oldIndex], this.imageList[newIndex]]
                    }
                },
                ].filter(Boolean)}
            >
                                ...
                                <span class="el-upload-list__item-preview">
                                    <i class="el-icon-zoom-in"
                                        onClick={(e: MouseEvent) => {
                                            e.stopPropagation()
                                            this.current = this.imageList.findIndex((image: any) => image.uid === file.uid)
                                            this.preview = true
                                        }}
                                    />
                                </span>
